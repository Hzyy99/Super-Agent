...
LLM_PROVIDERS: list[LLMProvider] = [
    ...
    LLMProvider(
        ...
        use="harness.models.vllm_provider:VllmChatModel",
    ...
    LLMProvider(
        ...
        use="harness.models.openai_codex_provider:CodexChatModel",
    ...
    LLMProvider(
        ...
        use="harness.models.claude_provider:ClaudeChatModel",
...
SEARCH_PROVIDERS: list[SearchProvider] = [
    ...
    SearchProvider(
        ...
        use="harness.community.tavily.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="harness.community.infoquest.tools:web_search_tool",
    ...
    SearchProvider(
        ...
        use="harness.community.exa.tools:web_search_tool",
        env_var="EXA_API_KEY",
        extra_config={
            "max_results": 5,
            "search_type": "auto",
    ...
    SearchProvider(
        ...
        use="harness.community.firecrawl.tools:web_search_tool",
...
WEB_FETCH_PROVIDERS: list[WebProvider] = [
    ...
    WebProvider(
        ...
        use="harness.community.exa.tools:web_fetch_tool",
        env_var="EXA_API_KEY",
        tool_name="web_fetch",
    ),
    WebProvider(
        ...
        display_name="InfoQuest",
        description="API key required",
        use="harness.community.infoquest.tools:web_fetch_tool",
        env_var="INFOQUEST_API_KEY",
        tool_name="web_fetch",
    ...
    WebProvider(
        ...
        use="harness.community.firecrawl.tools:web_fetch_tool",
        env_var="FIRECRAWL_API_KEY",
        tool_name="web_fetch",
    ),
]
