...
from harness.config.runtime_paths import project_root, resolve_path
...
class SkillsConfig(BaseModel):
    ...
    use: str = Field(
        default="harness.skills.storage.local_skill_storage:LocalSkillStorage",
    ...
    def get_skill_container_path(self, skill_name: str, category: str = "public") -> str:
        ...
        Args:
            ...
            category: Category of the skill (public/built-in or custom)

        Returns:
            Full path to the skill in the container
        """
        if category in {"public", "builtin", "built-in", ""}:
