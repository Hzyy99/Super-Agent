...
from harness.agents.middlewares.tool_error_handling_middleware import ToolErrorHandlingMiddleware
from harness.agents.thread_state import ThreadState
from harness.tools.builtins import ask_clarification_tool
    ...
    *,
    ...
    if feat.sandbox is not False:
        if isinstance(feat.sandbox, AgentMiddleware):
            ...
            from harness.agents.middlewares.thread_data_middleware import ThreadDataMiddleware
            from harness.agents.middlewares.uploads_middleware import UploadsMiddleware
            from harness.sandbox.middleware import SandboxMiddleware
    ...
    if feat.vision is not False:
        ...
        if feat.sandbox is not False:
            from harness.tools.builtins import view_image_tool
    ...
    if feat.subagent is not False:
        ...
        from harness.tools.builtins import task_tool
