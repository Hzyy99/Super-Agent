...
from harness.reflection import resolve_variable
from harness.sandbox.security import is_host_bash_allowed
from harness.tools.builtins import ask_clarification_tool, present_file_tool, task_tool, view_image_tool
from harness.tools.builtins.tool_search import reset_deferred_registry
...
def _is_host_bash_tool(tool: object) -> bool:
    ...
    if group == "bash":
        return True
    if use == "harness.sandbox.tools:bash_tool":
        return True
    return False
...
def get_available_tools(
    ...
    *,
    ...
    `initialize_mcp_tools()` from harness.mcp module.
    ...
    if getattr(skill_evolution_config, "enabled", False):
        from harness.tools.skill_manage_tool import skill_manage_tool
    ...
    if include_mcp:
        try:
            ...
            from harness.mcp.cache import get_cached_mcp_tools
            ...
            if extensions_config.get_enabled_mcp_servers():
                ...
                if mcp_tools:
                    ...
                    if config.tool_search.enabled:
                        from harness.tools.builtins.tool_search import DeferredToolRegistry, set_deferred_registry
                        from harness.tools.builtins.tool_search import tool_search as tool_search_tool
    ...
    try:
        from harness.tools.builtins.invoke_acp_agent_tool import build_invoke_acp_agent_tool

        if app_config is None:
            from harness.config.acp_config import get_acp_agents
