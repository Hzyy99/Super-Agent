...
from harness.agents.thread_state import ThreadDataState
...
from harness.sandbox.file_operation_lock import get_file_operation_lock
from harness.sandbox.sandbox import Sandbox
from harness.sandbox.sandbox_provider import get_sandbox_provider
from harness.sandbox.search import GrepMatch
from harness.sandbox.security import LOCAL_HOST_BASH_DISABLED_MESSAGE, is_host_bash_allowed
...
def _get_mcp_allowed_paths() -> list[str]:
    ...
    allowed_paths = []
    try:
        from harness.config.extensions_config import get_extensions_config
