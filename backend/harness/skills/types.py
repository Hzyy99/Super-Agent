...
class SkillCategory(StrEnum):
    ...
    - ``PUBLIC``: built-in skill bundled at the skills root, read-only.
...
class Skill:
    ...
    category: SkillCategory  # built-in/public or custom
    ...
    def get_container_path(self, container_base_path: str = "/mnt/skills") -> str:
        ...
        """
        category_base = container_base_path if self.category == SkillCategory.PUBLIC else f"{container_base_path}/{self.category}"
