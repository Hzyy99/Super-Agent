...
from harness.agents.lead_agent.agent import _build_middlewares
from harness.agents.lead_agent.prompt import apply_prompt_template
from harness.agents.thread_state import ThreadState
from harness.config.agents_config import AGENT_NAME_PATTERN
from harness.config.app_config import get_app_config, reload_app_config
from harness.config.extensions_config import ExtensionsConfig, SkillStateConfig, get_extensions_config, reload_extensions_config
...
class DeerFlowClient:
    ...
    def list_threads(self, limit: int = 10) -> dict:
        ...
        checkpointer = self._checkpointer
        if checkpointer is None:
            from harness.runtime.checkpointer.provider import get_checkpointer
    ...
    def get_memory(self) -> dict:
        ...
        """
        from harness.agents.memory.updater import get_memory_data
    ...
    def import_memory(self, memory_data: dict) -> dict:
        ...
        from harness.agents.memory.updater import import_memory_data
    ...
    def reload_memory(self) -> dict:
        ...
        """
        from harness.agents.memory.updater import reload_memory_data

        return reload_memory_data(user_id=get_effective_user_id())

    def clear_memory(self) -> dict:
        """Clear all persisted memory data."""
        from harness.agents.memory.updater import clear_memory_data
    ...
    def create_memory_fact(self, content: str, category: str = "context", confidence: float = 0.5) -> dict:
        ...
        from harness.agents.memory.updater import create_memory_fact

        return create_memory_fact(content=content, category=category, confidence=confidence)

    def delete_memory_fact(self, fact_id: str) -> dict:
        """Delete a single fact from memory by fact id."""
        from harness.agents.memory.updater import delete_memory_fact
    ...
    def update_memory_fact(
        ...
        from harness.agents.memory.updater import update_memory_fact
    ...
    def upload_files(self, thread_id: str, files: list[str | Path]) -> dict:
        ...
        """
        from harness.utils.file_conversion import CONVERTIBLE_EXTENSIONS, convert_file_to_markdown
    ...
    def delete_upload(self, thread_id: str, filename: str) -> dict:
        ...
        """
        from harness.utils.file_conversion import CONVERTIBLE_EXTENSIONS
