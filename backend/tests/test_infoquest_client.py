...
from harness.community.infoquest import tools
from harness.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("harness.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("harness.community.infoquest.tools._get_infoquest_client")
    ...
    @patch("harness.community.infoquest.tools.get_app_config")
