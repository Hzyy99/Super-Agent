"""Tests for harness.models.factory.create_chat_model."""
...
from harness.models import factory as factory_module
from harness.models import openai_codex_provider as codex_provider_module
...
def test_no_duplicate_kwarg_when_reasoning_effort_in_config_and_thinking_disabled(monkeypatch):
    ...
    model = ModelConfig(
        ...
        description=None,
        use="harness.models.patched_deepseek:PatchedChatDeepSeek",
