...
1. Read the image-generation skill: `/mnt/skills/image-generation/SKILL.md`
...
```bash
python /mnt/skills/image-generation/scripts/generate.py \
...
```bash
python /mnt/skills/ppt-generation/scripts/generate.py \
...
Read `/mnt/skills/image-generation/SKILL.md` to understand how to generate images.
